...
ENV_API_PORT = "ARIZE_API_PORT"
ENV_OTLP_PORT = "ARIZE_OTLP_PORT"
...
ENV_SSL_CA_CERT = "ARIZE_SSL_CA_CERT"
ENV_PROXY_URL = "ARIZE_PROXY_URL"
...
DEFAULT_API_PORT = 0  # 0 = use scheme default, omit port from URL
DEFAULT_OTLP_PORT = 0  # 0 = use scheme default, omit port from URL
DEFAULT_PYARROW_MAX_CHUNKSIZE = 10_000
DEFAULT_REQUEST_VERIFY = True
DEFAULT_MAX_HTTP_PAYLOAD_SIZE_MB = 8
...
DEFAULT_STREAM_MAX_QUEUE_BOUND = 5_000
