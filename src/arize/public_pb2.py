...
_DATASETCREATECONSTANTS = DESCRIPTOR.message_types_by_name['DatasetCreateConstants']
_DATASETCREATECONSTANTS_COLUMNMAPPINGENTRY = _DATASETCREATECONSTANTS.nested_types_by_name['ColumnMappingEntry']
_DATASETUPDATECONSTANTS = DESCRIPTOR.message_types_by_name['DatasetUpdateConstants']
_DATASETCONSTANTS = DESCRIPTOR.message_types_by_name['DatasetConstants']
...
_DATASETSCHEMA_CONSTANTS_COLUMNMAPPINGENTRY = _DATASETSCHEMA_CONSTANTS.nested_types_by_name['ColumnMappingEntry']
...
DatasetCreateConstants = _reflection.GeneratedProtocolMessageType('DatasetCreateConstants', (_message.Message,), {

  'ColumnMappingEntry' : _reflection.GeneratedProtocolMessageType('ColumnMappingEntry', (_message.Message,), {
    'DESCRIPTOR' : _DATASETCREATECONSTANTS_COLUMNMAPPINGENTRY,
    '__module__' : 'public_pb2'
    # @@protoc_insertion_point(class_scope:public.DatasetCreateConstants.ColumnMappingEntry)
    })
  ,
  'DESCRIPTOR' : _DATASETCREATECONSTANTS,
  '__module__' : 'public_pb2'
  # @@protoc_insertion_point(class_scope:public.DatasetCreateConstants)
  })
_sym_db.RegisterMessage(DatasetCreateConstants)
_sym_db.RegisterMessage(DatasetCreateConstants.ColumnMappingEntry)

DatasetUpdateConstants = _reflection.GeneratedProtocolMessageType('DatasetUpdateConstants', (_message.Message,), {
  'DESCRIPTOR' : _DATASETUPDATECONSTANTS,
  '__module__' : 'public_pb2'
  # @@protoc_insertion_point(class_scope:public.DatasetUpdateConstants)
  })
_sym_db.RegisterMessage(DatasetUpdateConstants)

DatasetConstants = _reflection.GeneratedProtocolMessageType('DatasetConstants', (_message.Message,), {
  'DESCRIPTOR' : _DATASETCONSTANTS,
  '__module__' : 'public_pb2'
  # @@protoc_insertion_point(class_scope:public.DatasetConstants)
  })
_sym_db.RegisterMessage(DatasetConstants)
...
DatasetSchema = _reflection.GeneratedProtocolMessageType('DatasetSchema', (_message.Message,), {
  ...
  'Constants' : _reflection.GeneratedProtocolMessageType('Constants', (_message.Message,), {
    ...
    'ColumnMappingEntry' : _reflection.GeneratedProtocolMessageType('ColumnMappingEntry', (_message.Message,), {
      'DESCRIPTOR' : _DATASETSCHEMA_CONSTANTS_COLUMNMAPPINGENTRY,
      '__module__' : 'public_pb2'
      # @@protoc_insertion_point(class_scope:public.DatasetSchema.Constants.ColumnMappingEntry)
      })
    ,
...
_sym_db.RegisterMessage(DatasetSchema.Constants.ColumnMappingEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DATASETCREATECONSTANTS_COLUMNMAPPINGENTRY._options = None
  _DATASETCREATECONSTANTS_COLUMNMAPPINGENTRY._serialized_options = b'8\001'
  _DATASETSCHEMA_CONSTANTS_COLUMNMAPPINGENTRY._options = None
  _DATASETSCHEMA_CONSTANTS_COLUMNMAPPINGENTRY._serialized_options = b'8\001'
  _DATASETSCHEMA.fields_by_name['constants']._options = None
  _DATASETSCHEMA.fields_by_name['constants']._serialized_options = b'\030\001'
  _SCHEMATYPE._serialized_start=15201
  _SCHEMATYPE._serialized_end=15237
  ...
  _DATASETCREATECONSTANTS._serialized_start=14291
  _DATASETCREATECONSTANTS._serialized_end=14486
  _DATASETCREATECONSTANTS_COLUMNMAPPINGENTRY._serialized_start=14434
  _DATASETCREATECONSTANTS_COLUMNMAPPINGENTRY._serialized_end=14486
  _DATASETUPDATECONSTANTS._serialized_start=14488
  _DATASETUPDATECONSTANTS._serialized_end=14540
  _DATASETCONSTANTS._serialized_start=14543
  _DATASETCONSTANTS._serialized_end=14710
  _DATASETSCHEMA._serialized_start=14713
  _DATASETSCHEMA._serialized_end=15064
  _DATASETSCHEMA_CONSTANTS._serialized_start=14881
  _DATASETSCHEMA_CONSTANTS._serialized_end=15064
  _DATASETSCHEMA_CONSTANTS_COLUMNMAPPINGENTRY._serialized_start=14434
  _DATASETSCHEMA_CONSTANTS_COLUMNMAPPINGENTRY._serialized_end=14486
  _ARROWFILEUPLOADRESPONSE._serialized_start=15066
  _ARROWFILEUPLOADRESPONSE._serialized_end=15139
  _USERFILEUPLOADRESPONSE._serialized_start=15141
  _USERFILEUPLOADRESPONSE._serialized_end=15199
