...
template_evaluation_run_config_request_instance = TemplateEvaluationRunConfigRequest.from_json(json)
# print the JSON string representation of the object
print(TemplateEvaluationRunConfigRequest.to_json())

# convert the object into a dict
template_evaluation_run_config_request_dict = template_evaluation_run_config_request_instance.to_dict()
# create an instance of TemplateEvaluationRunConfigRequest from a dict
template_evaluation_run_config_request_from_dict = TemplateEvaluationRunConfigRequest.from_dict(template_evaluation_run_config_request_dict)
```
