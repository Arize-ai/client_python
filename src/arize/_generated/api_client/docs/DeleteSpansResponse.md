...
delete_spans_response_instance = DeleteSpansResponse.from_json(json)
# print the JSON string representation of the object
print(DeleteSpansResponse.to_json())

# convert the object into a dict
delete_spans_response_dict = delete_spans_response_instance.to_dict()
# create an instance of DeleteSpansResponse from a dict
delete_spans_response_from_dict = DeleteSpansResponse.from_dict(delete_spans_response_dict)
```
