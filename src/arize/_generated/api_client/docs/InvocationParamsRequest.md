...
Parameters for the LLM invocation in a write request (strict form of InvocationParams; leaf schemas use *Request variants)
...
**response_format** | [**ResponseFormatRequest**](ResponseFormatRequest.md) | Response format configuration. Optional. When omitted, no structured output constraint is applied (the provider&#39;s default plain-text behavior is used). | [optional] 
**tool_config** | [**ToolConfigRequest**](ToolConfigRequest.md) | Tool configuration for the LLM invocation. Optional. When omitted, no tools are made available to the model. | [optional] 
...
json = "{}"
# create an instance of InvocationParamsRequest from a JSON string
invocation_params_request_instance = InvocationParamsRequest.from_json(json)
# print the JSON string representation of the object
print(InvocationParamsRequest.to_json())

# convert the object into a dict
invocation_params_request_dict = invocation_params_request_instance.to_dict()
# create an instance of InvocationParamsRequest from a dict
invocation_params_request_from_dict = InvocationParamsRequest.from_dict(invocation_params_request_dict)
```
