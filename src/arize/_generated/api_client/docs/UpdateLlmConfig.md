...
**base_url** | **str** | (&#x60;CUSTOM&#x60;, &#x60;NVIDIA_NIM&#x60;, and &#x60;ANTHROPIC&#x60; only) New endpoint URL. For &#x60;NVIDIA_NIM&#x60; and &#x60;ANTHROPIC&#x60; the field is optional on the resource, so null clears it (falling back to the provider default endpoint). For &#x60;CUSTOM&#x60; it is required on the resource — null is rejected with 422. Omit to keep unchanged. | [optional] 
