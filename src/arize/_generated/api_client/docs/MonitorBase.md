...
**type** | [**MonitorType**](MonitorType.md) | Required on create. Immutable after creation. | 
...
json = "{}"
# create an instance of MonitorBase from a JSON string
monitor_base_instance = MonitorBase.from_json(json)
# print the JSON string representation of the object
print(MonitorBase.to_json())

# convert the object into a dict
monitor_base_dict = monitor_base_instance.to_dict()
# create an instance of MonitorBase from a dict
monitor_base_from_dict = MonitorBase.from_dict(monitor_base_dict)
```
