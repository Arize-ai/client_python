...
# **prompts_list**
> PromptsList200Response prompts_list(space_id=space_id, name=name, limit=limit, cursor=cursor)
...
with arize._generated.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List prompts
        api_response = api_instance.prompts_list(space_id=space_id, name=name, limit=limit, cursor=cursor)
