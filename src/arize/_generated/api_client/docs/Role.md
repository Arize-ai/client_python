...
**permissions** | [**List[Permission]**](Permission.md) | List of permissions granted by this role. Each value corresponds to a permission identifier (e.g. &#x60;PROJECT_READ&#x60;, &#x60;DATASET_CREATE&#x60;). Returned only to callers with &#x60;ROLE_READ&#x60;.  | 
