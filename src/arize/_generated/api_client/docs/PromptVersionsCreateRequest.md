...
json = "{}"
# create an instance of PromptVersionsCreateRequest from a JSON string
prompt_versions_create_request_instance = PromptVersionsCreateRequest.from_json(json)
# print the JSON string representation of the object
print(PromptVersionsCreateRequest.to_json())

# convert the object into a dict
prompt_versions_create_request_dict = prompt_versions_create_request_instance.to_dict()
# create an instance of PromptVersionsCreateRequest from a dict
prompt_versions_create_request_from_dict = PromptVersionsCreateRequest.from_dict(prompt_versions_create_request_dict)
```
