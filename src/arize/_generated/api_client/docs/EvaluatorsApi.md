...
# **evaluators_list**
> EvaluatorsList200Response evaluators_list(space_id=space_id, limit=limit, cursor=cursor)
...
with arize._generated.api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List evaluators
        api_response = api_instance.evaluators_list(space_id=space_id, limit=limit, cursor=cursor)
