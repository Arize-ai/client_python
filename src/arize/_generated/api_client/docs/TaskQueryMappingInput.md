...
task_query_mapping_input_instance = TaskQueryMappingInput.from_json(json)
# print the JSON string representation of the object
print(TaskQueryMappingInput.to_json())

# convert the object into a dict
task_query_mapping_input_dict = task_query_mapping_input_instance.to_dict()
# create an instance of TaskQueryMappingInput from a dict
task_query_mapping_input_from_dict = TaskQueryMappingInput.from_dict(task_query_mapping_input_dict)
```
