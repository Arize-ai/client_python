...
**custom_metric_id** | **str** | The custom metric this monitor evaluates (base64 global ID).   | 
...
json = "{}"
# create an instance of CustomMetricMonitor from a JSON string
custom_metric_monitor_instance = CustomMetricMonitor.from_json(json)
# print the JSON string representation of the object
print(CustomMetricMonitor.to_json())

# convert the object into a dict
custom_metric_monitor_dict = custom_metric_monitor_instance.to_dict()
# create an instance of CustomMetricMonitor from a dict
custom_metric_monitor_from_dict = CustomMetricMonitor.from_dict(custom_metric_monitor_dict)
```
