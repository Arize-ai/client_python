...
class ResponseFormatRequest(BaseModel):
    ...
    json_schema: Optional[JsonSchemaConfigRequest] = Field(default=None, description="JSON schema configuration (when type is JSON_SCHEMA)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ResponseFormatRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type"),
            "json_schema": JsonSchemaConfigRequest.from_dict(obj["json_schema"]) if obj.get("json_schema") is not None else None
        })
        return _obj
