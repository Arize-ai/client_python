...
class CreateAwsBedrockConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["provider", "auth", "is_default_models_enabled", "model_names"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateAwsBedrockConfig) in the input: " + _key)
