...
class UpdateProjectRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="New project name. Must be unique within the space.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpdateProjectRequest) in the input: " + _key)
