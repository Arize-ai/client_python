...
class InsertExperimentRunsRequest(BaseModel):
    """
    InsertExperimentRunsRequest
    """ # noqa: E501
    experiment_runs: Annotated[List[ExperimentRunInput], Field(min_length=1, max_length=1000)] = Field(description="Array of experiment run data to append to the experiment. Between 1 and 1000 runs per request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InsertExperimentRunsRequest) in the input: " + _key)
