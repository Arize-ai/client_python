...
class WebhookSubscriptionInput(BaseModel):
    ...
    """ # noqa: E501
    webhook_id: StrictStr = Field(description="The unique identifier of the webhook to attach")
    subscribed_events: Annotated[List[WebhookEventType], Field(min_length=1)] = Field(description="The events to deliver to the webhook. Must contain at least one event valid for the resource type.")
    __properties: ClassVar[List[str]] = ["webhook_id", "subscribed_events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WebhookSubscriptionInput) in the input: " + _key)
