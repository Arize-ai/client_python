...
class UpdateFreeformAnnotationConfigRequest(BaseModel):
    """
    ...
    annotation_config_type: StrictStr = Field(description="Discriminator value identifying a freeform annotation config. The config `type` is immutable and must match the stored config's type. ")
    __properties: ClassVar[List[str]] = ["name", "annotation_config_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpdateFreeformAnnotationConfigRequest) in the input: " + _key)
