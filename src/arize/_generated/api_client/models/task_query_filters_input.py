...
class TaskQueryFiltersInput(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TaskQueryFiltersInput) in the input: " + _key)

        _obj = cls.model_validate({
            "filters": [TaskQueryFilterInput.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
