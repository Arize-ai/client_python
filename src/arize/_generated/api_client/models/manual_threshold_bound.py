...
class ManualThresholdBound(BaseModel):
    """
    ManualThresholdBound
    """ # noqa: E501
    operator: ThresholdOperator
    value: Union[StrictFloat, StrictInt] = Field(description="The bound value the computed metric is compared against.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ManualThresholdBound) in the input: " + _key)
