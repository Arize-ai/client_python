...
class AuditLogsList200Response(BaseModel):
    """
    AuditLogsList200Response
    """ # noqa: E501
    logs: List[AuditLog] = Field(description="A list of audit log entries, newest first.")
    pagination: PaginationMetadata
    __properties: ClassVar[List[str]] = ["logs", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AuditLogsList200Response) in the input: " + _key)
