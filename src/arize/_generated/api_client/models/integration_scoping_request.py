...
class IntegrationScopingRequest(BaseModel):
    """
    ...
    space_id: Optional[StrictStr] = Field(default=None, description="Space identifier (base64). Null means organization-wide (or account-wide when organization_id is also null).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IntegrationScopingRequest) in the input: " + _key)
