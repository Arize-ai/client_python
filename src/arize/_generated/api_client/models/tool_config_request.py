...
class ToolConfigRequest(BaseModel):
    ...
    """ # noqa: E501
    tools: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of tool definitions available to the model")
    tool_choice: Optional[Any] = Field(default=None, description="Tool choice configuration")
    __properties: ClassVar[List[str]] = ["tools", "tool_choice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ToolConfigRequest) in the input: " + _key)
