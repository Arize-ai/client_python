...
class AwsBedrockProxyWithHeadersAuth(BaseModel):
    """
    ...
    base_url: StrictStr = Field(description="Proxy URL requests are forwarded to.")
    ...
    __properties: ClassVar[List[str]] = ["auth_type", "base_url", "header_names"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AwsBedrockProxyWithHeadersAuth) in the input: " + _key)
