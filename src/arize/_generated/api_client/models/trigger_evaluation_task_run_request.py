...
class TriggerEvaluationTaskRunRequest(BaseModel):
    ...
    """ # noqa: E501
    data_start_time: Optional[datetime] = Field(default=None, description="ISO 8601 start of the data window to evaluate. If omitted, defaults to the task's last run time (or 7 days ago on first run). ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TriggerEvaluationTaskRunRequest) in the input: " + _key)
