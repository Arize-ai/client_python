    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateEvaluatorRequest) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "version": CreateEvaluatorVersionRequest.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
