...
class DatasetsExamplesUpdateRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DatasetsExamplesUpdateRequest) in the input: " + _key)

        _obj = cls.model_validate({
            "examples": [DatasetExampleUpdate.from_dict(_item) for _item in obj["examples"]] if obj.get("examples") is not None else None,
