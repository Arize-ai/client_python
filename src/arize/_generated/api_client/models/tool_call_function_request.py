...
class ToolCallFunctionRequest(BaseModel):
    """
    The function to call (strict request form of ToolCallFunction)
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the function")
    arguments: StrictStr = Field(description="The arguments to the function as a JSON string")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ToolCallFunctionRequest) in the input: " + _key)
