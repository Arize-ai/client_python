...
class AwsBedrockDefaultAuth(BaseModel):
    """
    ...
    external_id: Optional[StrictStr] = Field(description="External ID on the assume-role policy. Null when not set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AwsBedrockDefaultAuth) in the input: " + _key)
