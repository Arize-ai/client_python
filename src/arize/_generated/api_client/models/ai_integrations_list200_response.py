...
class AiIntegrationsList200Response(BaseModel):
    """
    AiIntegrationsList200Response
    """ # noqa: E501
    ai_integrations: List[AiIntegration] = Field(description="A list of AI integrations")
    pagination: PaginationMetadata
    __properties: ClassVar[List[str]] = ["ai_integrations", "pagination"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ai_integrations (list)
        _items = []
        if self.ai_integrations:
            for _item_ai_integrations in self.ai_integrations:
                if _item_ai_integrations:
                    _items.append(_item_ai_integrations.to_dict())
            _dict['ai_integrations'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AiIntegrationsList200Response) in the input: " + _key)
