...
class FreeformAnnotationConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Discriminator value identifying a freeform annotation config.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in FreeformAnnotationConfig) in the input: " + _key)
