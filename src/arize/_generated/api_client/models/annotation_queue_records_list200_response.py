...
class AnnotationQueueRecordsList200Response(BaseModel):
    """
    AnnotationQueueRecordsList200Response
    """ # noqa: E501
    records: List[AnnotationQueueRecord] = Field(description="A list of annotation queue records")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AnnotationQueueRecordsList200Response) in the input: " + _key)

        _obj = cls.model_validate({
            "records": [AnnotationQueueRecord.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
