...
class TaskQueryFilterInput(BaseModel):
    """
    ...
    def id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[A-E]$", value):
            raise ValueError(r"must validate the regular expression /^[A-E]$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TaskQueryFilterInput) in the input: " + _key)
