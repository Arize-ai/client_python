...
class IntegrationBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "name", "scopings", "created_at", "updated_at", "created_by_user_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IntegrationBase) in the input: " + _key)
