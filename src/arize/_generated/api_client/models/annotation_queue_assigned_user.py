...
class AnnotationQueueAssignedUser(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AnnotationQueueAssignedUser) in the input: " + _key)

        _obj = cls.model_validate({
            "user": AnnotatorUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
