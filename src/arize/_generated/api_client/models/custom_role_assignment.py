...
class CustomRoleAssignment(BaseModel):
    ...
    """ # noqa: E501
    type: SpaceRoleAssignmentType = Field(description="Discriminator identifying this as a custom RBAC role assignment. Always `CUSTOM` for this variant.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CustomRoleAssignment) in the input: " + _key)
