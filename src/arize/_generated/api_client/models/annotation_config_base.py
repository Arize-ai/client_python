...
class AnnotationConfigBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "created_at", "space_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AnnotationConfigBase) in the input: " + _key)
