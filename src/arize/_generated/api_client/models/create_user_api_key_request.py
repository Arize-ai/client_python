...
class CreateUserApiKeyRequest(BaseModel):
    ...
    """ # noqa: E501
    key_type: StrictStr = Field(description="Must be `\"USER\"`.")
    ...
    __properties: ClassVar[List[str]] = ["key_type", "name", "description", "expires_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateUserApiKeyRequest) in the input: " + _key)
