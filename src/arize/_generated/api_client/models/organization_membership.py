...
class OrganizationMembership(BaseModel):
    ...
    organization_id: StrictStr = Field(description="The unique identifier of the organization")
    role: OrganizationRoleAssignment
    __properties: ClassVar[List[str]] = ["id", "user_id", "organization_id", "role"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OrganizationMembership) in the input: " + _key)
