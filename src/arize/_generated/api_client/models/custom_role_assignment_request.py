...
class CustomRoleAssignmentRequest(BaseModel):
    """
    A custom RBAC role assignment in a write request (strict form of CustomRoleAssignment).
    """ # noqa: E501
    type: SpaceRoleAssignmentType = Field(description="Discriminator identifying this as a custom RBAC role assignment. Must be `CUSTOM`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CustomRoleAssignmentRequest) in the input: " + _key)
