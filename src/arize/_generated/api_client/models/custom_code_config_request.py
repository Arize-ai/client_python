...
class CustomCodeConfigRequest(BaseModel):
    """
    ...
    static_params: Optional[List[StaticParamRequest]] = Field(default=None, description="Optional typed defaults accessible on the evaluator instance. Omit or pass an empty array when the custom class does not read any static parameters. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CustomCodeConfigRequest) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "static_params": [StaticParamRequest.from_dict(_item) for _item in obj["static_params"]] if obj.get("static_params") is not None else None
        })
        return _obj
