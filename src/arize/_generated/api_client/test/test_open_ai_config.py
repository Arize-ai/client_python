...
class TestOpenAiConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OpenAiConfig:
        """Test OpenAiConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenAiConfig`
        """
        model = OpenAiConfig()
        if include_optional:
            return OpenAiConfig(
