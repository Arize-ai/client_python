...
class TestAzureParams(unittest.TestCase):
    """AzureParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AzureParams:
        """Test AzureParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AzureParams`
        """
        model = AzureParams()
        if include_optional:
            return AzureParams(
