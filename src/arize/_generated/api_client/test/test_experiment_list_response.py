...
class TestExperimentListResponse(unittest.TestCase):
    """ExperimentListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperimentListResponse:
        """Test ExperimentListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExperimentListResponse`
        """
        model = ExperimentListResponse()
        if include_optional:
    ...
    def testExperimentListResponse(self):
        """Test ExperimentListResponse"""
