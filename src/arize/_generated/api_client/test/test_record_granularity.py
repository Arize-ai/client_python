...
class TestRecordGranularity(unittest.TestCase):
    """RecordGranularity unit test stubs"""
    ...
    def testRecordGranularity(self):
        """Test RecordGranularity"""
        # inst = RecordGranularity()
