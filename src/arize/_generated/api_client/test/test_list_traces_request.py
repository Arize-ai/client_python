...
class TestListTracesRequest(unittest.TestCase):
    """ListTracesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTracesRequest:
        """Test ListTracesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTracesRequest`
        """
    ...
    def testListTracesRequest(self):
        """Test ListTracesRequest"""
