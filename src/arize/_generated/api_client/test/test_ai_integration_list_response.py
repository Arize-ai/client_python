...
class TestAiIntegrationListResponse(unittest.TestCase):
    """AiIntegrationListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AiIntegrationListResponse:
        """Test AiIntegrationListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AiIntegrationListResponse`
        """
        model = AiIntegrationListResponse()
        if include_optional:
            return AiIntegrationListResponse(
                ai_integrations = [
    ...
    def testAiIntegrationListResponse(self):
        """Test AiIntegrationListResponse"""
