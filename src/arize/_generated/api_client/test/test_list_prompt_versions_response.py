...
class TestListPromptVersionsResponse(unittest.TestCase):
    """ListPromptVersionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPromptVersionsResponse:
        """Test ListPromptVersionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPromptVersionsResponse`
        """
        model = ListPromptVersionsResponse()
        if include_optional:
    ...
    def testListPromptVersionsResponse(self):
        """Test ListPromptVersionsResponse"""
