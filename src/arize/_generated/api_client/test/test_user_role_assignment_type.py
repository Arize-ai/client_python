...
class TestUserRoleAssignmentType(unittest.TestCase):
    """UserRoleAssignmentType unit test stubs"""
    ...
    def testUserRoleAssignmentType(self):
        """Test UserRoleAssignmentType"""
        # inst = UserRoleAssignmentType()
