...
class TestResourceRestriction(unittest.TestCase):
    """ResourceRestriction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceRestriction:
        """Test ResourceRestriction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceRestriction`
        """
    ...
    def testResourceRestriction(self):
        """Test ResourceRestriction"""
