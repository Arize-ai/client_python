...
class TestSpaceRoleAssignmentType(unittest.TestCase):
    """SpaceRoleAssignmentType unit test stubs"""
    ...
    def testSpaceRoleAssignmentType(self):
        """Test SpaceRoleAssignmentType"""
        # inst = SpaceRoleAssignmentType()
