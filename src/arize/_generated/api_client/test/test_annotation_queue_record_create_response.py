...
class TestAnnotationQueueRecordCreateResponse(unittest.TestCase):
    """AnnotationQueueRecordCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnnotationQueueRecordCreateResponse:
        """Test AnnotationQueueRecordCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnnotationQueueRecordCreateResponse`
        """
        model = AnnotationQueueRecordCreateResponse()
        if include_optional:
            return AnnotationQueueRecordCreateResponse(
                record_sources = [
    ...
    def testAnnotationQueueRecordCreateResponse(self):
        """Test AnnotationQueueRecordCreateResponse"""
