...
class TestApiKeyAccountRole(unittest.TestCase):
    """ApiKeyAccountRole unit test stubs"""
    ...
    def testApiKeyAccountRole(self):
        """Test ApiKeyAccountRole"""
        # inst = ApiKeyAccountRole()
