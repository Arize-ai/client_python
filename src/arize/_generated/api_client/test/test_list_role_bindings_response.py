...
class TestListRoleBindingsResponse(unittest.TestCase):
    """ListRoleBindingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRoleBindingsResponse:
        """Test ListRoleBindingsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRoleBindingsResponse`
        """
        model = ListRoleBindingsResponse()
        if include_optional:
    ...
    def testListRoleBindingsResponse(self):
        """Test ListRoleBindingsResponse"""
