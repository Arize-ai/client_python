...
class TestOrganizationRoleAssignmentType(unittest.TestCase):
    """OrganizationRoleAssignmentType unit test stubs"""
    ...
    def testOrganizationRoleAssignmentType(self):
        """Test OrganizationRoleAssignmentType"""
        # inst = OrganizationRoleAssignmentType()
