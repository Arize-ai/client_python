...
class TestAnnotationConfigType(unittest.TestCase):
    """AnnotationConfigType unit test stubs"""
    ...
    def testAnnotationConfigType(self):
        """Test AnnotationConfigType"""
        # inst = AnnotationConfigType()
