...
class TestCreateRoleBindingRequest(unittest.TestCase):
    """CreateRoleBindingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRoleBindingRequest:
        """Test CreateRoleBindingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRoleBindingRequest`
        """
    ...
    def testCreateRoleBindingRequest(self):
        """Test CreateRoleBindingRequest"""
