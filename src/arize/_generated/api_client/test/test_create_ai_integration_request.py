...
class TestCreateAiIntegrationRequest(unittest.TestCase):
    """CreateAiIntegrationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAiIntegrationRequest:
        """Test CreateAiIntegrationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAiIntegrationRequest`
        """
        model = CreateAiIntegrationRequest()
        if include_optional:
            return CreateAiIntegrationRequest(
                name = '',
                provider = 'OPEN_AI',
                api_key = '',
                base_url = '',
    ...
    def testCreateAiIntegrationRequest(self):
        """Test CreateAiIntegrationRequest"""
