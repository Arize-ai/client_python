...
class TestAnnotationQueueSourceType(unittest.TestCase):
    """AnnotationQueueSourceType unit test stubs"""
    ...
    def testAnnotationQueueSourceType(self):
        """Test AnnotationQueueSourceType"""
        # inst = AnnotationQueueSourceType()
