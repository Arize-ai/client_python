...
class TestLlmConfigBase(unittest.TestCase):
    """LlmConfigBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LlmConfigBase:
        """Test LlmConfigBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LlmConfigBase`
        """
        model = LlmConfigBase()
        if include_optional:
