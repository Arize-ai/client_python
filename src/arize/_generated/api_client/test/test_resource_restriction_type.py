...
class TestResourceRestrictionType(unittest.TestCase):
    """ResourceRestrictionType unit test stubs"""
    ...
    def testResourceRestrictionType(self):
        """Test ResourceRestrictionType"""
        # inst = ResourceRestrictionType()
