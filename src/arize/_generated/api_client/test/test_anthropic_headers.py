...
class TestAnthropicHeaders(unittest.TestCase):
    """AnthropicHeaders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnthropicHeaders:
        """Test AnthropicHeaders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnthropicHeaders`
        """
        model = AnthropicHeaders()
        if include_optional:
