...
class TestDatasetExampleListResponse(unittest.TestCase):
    """DatasetExampleListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatasetExampleListResponse:
        """Test DatasetExampleListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatasetExampleListResponse`
        """
        model = DatasetExampleListResponse()
        if include_optional:
    ...
    def testDatasetExampleListResponse(self):
        """Test DatasetExampleListResponse"""
