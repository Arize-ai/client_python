...
class TestIntegrationListResponse(unittest.TestCase):
    """IntegrationListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationListResponse:
        """Test IntegrationListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationListResponse`
        """
    ...
    def testIntegrationListResponse(self):
        """Test IntegrationListResponse"""
