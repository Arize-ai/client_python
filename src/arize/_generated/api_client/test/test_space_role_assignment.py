...
class TestSpaceRoleAssignment(unittest.TestCase):
    """SpaceRoleAssignment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaceRoleAssignment:
        """Test SpaceRoleAssignment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaceRoleAssignment`
        """
    ...
    def testSpaceRoleAssignment(self):
        """Test SpaceRoleAssignment"""
