...
class TestExperimentRunListResponse(unittest.TestCase):
    """ExperimentRunListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperimentRunListResponse:
        """Test ExperimentRunListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExperimentRunListResponse`
        """
        model = ExperimentRunListResponse()
        if include_optional:
    ...
    def testExperimentRunListResponse(self):
        """Test ExperimentRunListResponse"""
