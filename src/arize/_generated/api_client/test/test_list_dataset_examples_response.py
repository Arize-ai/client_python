...
class TestListDatasetExamplesResponse(unittest.TestCase):
    """ListDatasetExamplesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDatasetExamplesResponse:
        """Test ListDatasetExamplesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDatasetExamplesResponse`
        """
        model = ListDatasetExamplesResponse()
        if include_optional:
    ...
    def testListDatasetExamplesResponse(self):
        """Test ListDatasetExamplesResponse"""
