...
class TestPromptsUpdateRequest(unittest.TestCase):
    """PromptsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromptsUpdateRequest:
        """Test PromptsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromptsUpdateRequest`
        """
    ...
    def testPromptsUpdateRequest(self):
        """Test PromptsUpdateRequest"""
