...
class TestSpaceListResponse(unittest.TestCase):
    """SpaceListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaceListResponse:
        """Test SpaceListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaceListResponse`
        """
    ...
    def testSpaceListResponse(self):
        """Test SpaceListResponse"""
