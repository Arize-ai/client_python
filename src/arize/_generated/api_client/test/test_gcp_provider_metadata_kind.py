...
class TestGcpProviderMetadataKind(unittest.TestCase):
    """GcpProviderMetadataKind unit test stubs"""
    ...
    def testGcpProviderMetadataKind(self):
        """Test GcpProviderMetadataKind"""
        # inst = GcpProviderMetadataKind()
