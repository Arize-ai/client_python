...
class TestListAnnotationConfigsResponse(unittest.TestCase):
    """ListAnnotationConfigsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAnnotationConfigsResponse:
        """Test ListAnnotationConfigsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAnnotationConfigsResponse`
        """
        model = ListAnnotationConfigsResponse()
        if include_optional:
    ...
    def testListAnnotationConfigsResponse(self):
        """Test ListAnnotationConfigsResponse"""
