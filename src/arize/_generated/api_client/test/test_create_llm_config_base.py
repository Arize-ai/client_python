...
class TestCreateLlmConfigBase(unittest.TestCase):
    """CreateLlmConfigBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateLlmConfigBase:
        """Test CreateLlmConfigBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateLlmConfigBase`
        """
    ...
    def testCreateLlmConfigBase(self):
        """Test CreateLlmConfigBase"""
