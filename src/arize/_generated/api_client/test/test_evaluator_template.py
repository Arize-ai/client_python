...
class TestEvaluatorTemplate(unittest.TestCase):
    """EvaluatorTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EvaluatorTemplate:
        """Test EvaluatorTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EvaluatorTemplate`
        """
...
{output}',
    ...
    def testEvaluatorTemplate(self):
        """Test EvaluatorTemplate"""
