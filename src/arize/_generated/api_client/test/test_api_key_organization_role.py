...
class TestApiKeyOrganizationRole(unittest.TestCase):
    """ApiKeyOrganizationRole unit test stubs"""
    ...
    def testApiKeyOrganizationRole(self):
        """Test ApiKeyOrganizationRole"""
        # inst = ApiKeyOrganizationRole()
