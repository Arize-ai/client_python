...
class TestAwsProviderMetadataKind(unittest.TestCase):
    """AwsProviderMetadataKind unit test stubs"""
    ...
    def testAwsProviderMetadataKind(self):
        """Test AwsProviderMetadataKind"""
        # inst = AwsProviderMetadataKind()
