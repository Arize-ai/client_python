...
class TestTracingDataQualityMetric(unittest.TestCase):
    """TracingDataQualityMetric unit test stubs"""
    ...
    def testTracingDataQualityMetric(self):
        """Test TracingDataQualityMetric"""
        # inst = TracingDataQualityMetric()
