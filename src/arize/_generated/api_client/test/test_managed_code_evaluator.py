...
class TestManagedCodeEvaluator(unittest.TestCase):
    """ManagedCodeEvaluator unit test stubs"""
    ...
    def testManagedCodeEvaluator(self):
        """Test ManagedCodeEvaluator"""
        # inst = ManagedCodeEvaluator()
