...
class TestAwsProviderMetadata(unittest.TestCase):
    """AwsProviderMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AwsProviderMetadata:
        """Test AwsProviderMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AwsProviderMetadata`
        """
    ...
    def testAwsProviderMetadata(self):
        """Test AwsProviderMetadata"""
