...
class TestCodeConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CodeConfig:
        """Test CodeConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodeConfig`
        """
        model = CodeConfig()
        if include_optional:
            return CodeConfig(
