...
class TestRoleBindingCreate(unittest.TestCase):
    """RoleBindingCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleBindingCreate:
        """Test RoleBindingCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleBindingCreate`
        """
        model = RoleBindingCreate()
        if include_optional:
            return RoleBindingCreate(
    ...
    def testRoleBindingCreate(self):
        """Test RoleBindingCreate"""
