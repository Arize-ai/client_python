...
_EMBEDDING_RAWDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='string', full_name='public.Embedding.RawData.string', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tokenArray', full_name='public.Embedding.RawData.tokenArray', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EMBEDDING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='raw_data', full_name='public.Embedding.raw_data', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EMBEDDING_RAWDATA.oneofs_by_name['type'].fields.append(
  _EMBEDDING_RAWDATA.fields_by_name['string'])
_EMBEDDING_RAWDATA.fields_by_name['string'].containing_oneof = _EMBEDDING_RAWDATA.oneofs_by_name['type']
_EMBEDDING_RAWDATA.oneofs_by_name['type'].fields.append(
...
_EMBEDDING.fields_by_name['data']._options = None
