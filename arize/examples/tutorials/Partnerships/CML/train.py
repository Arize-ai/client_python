...
# Load in the data
df = pd.read_csv("https://storage.googleapis.com/arize-assets/fixtures/wine_quality.csv")
...
arize_client = Client(organization_key=ORG_KEY, api_key=API_KEY,uri='https://devr.arize.com/v1')
