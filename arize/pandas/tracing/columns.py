...
SPAN_OPENINFERENCE_REQUIRED_COLUMNS = [col for col in SPAN_OPENINFERENCE_COLUMNS if col.required]
...
EVAL_COLUMN_PATTERN = (
    f"^{EVAL_COLUMN_PREFIX}[a-zA-Z0-9_]+?"
    f"({EVAL_LABEL_SUFFIX}|{EVAL_SCORE_SUFFIX}|{EVAL_EXPLANATION_SUFFIX})$"
)
EVAL_NAME_PATTERN = rf"^{EVAL_COLUMN_PREFIX}([a-zA-Z0-9_]+?)\."
EVAL_LABEL_PATTERN = f"^{EVAL_COLUMN_PREFIX}[a-zA-Z0-9_]+?{EVAL_LABEL_SUFFIX}$"
EVAL_SCORE_PATTERN = f"^{EVAL_COLUMN_PREFIX}[a-zA-Z0-9_]+?{EVAL_SCORE_SUFFIX}$"
EVAL_EXPLANATION_PATTERN = f"^{EVAL_COLUMN_PREFIX}[a-zA-Z0-9_]+?{EVAL_EXPLANATION_SUFFIX}$"
