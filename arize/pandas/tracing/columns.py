...
EVAL_LABEL_PATTERN = f"^{_EVAL_COLUMN_PREFIX_REGEX}{_EVAL_NAME_REGEX}{_EVAL_LABEL_SUFFIX_REGEX}$"
EVAL_SCORE_PATTERN = f"^{_EVAL_COLUMN_PREFIX_REGEX}{_EVAL_NAME_REGEX}{_EVAL_SCORE_SUFFIX_REGEX}$"
EVAL_EXPLANATION_PATTERN = (
    f"^{_EVAL_COLUMN_PREFIX_REGEX}{_EVAL_NAME_REGEX}{_EVAL_EXPLANATION_SUFFIX_REGEX}$"
)
