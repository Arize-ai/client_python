...
from arize.pandas.tracing.validation.spans import dataframe_form_validation as df_validation
...
def validate_dataframe_form(
    ...
    checks = chain(
        ...
        common_df_validation._check_dataframe_for_duplicate_columns(spans_dataframe),
        # Spans specific
