...
from arize.pandas.tracing.validation.common import argument_validation as common_arg_validation
from arize.pandas.tracing.validation.common import dataframe_form_validation as common_df_validation
from arize.pandas.tracing.validation.common import value_validation as common_value_validation
from arize.pandas.tracing.validation.evals import dataframe_form_validation as df_validation
...
def validate_dataframe_form(
    ...
    checks = chain(
        ...
        common_df_validation._check_dataframe_for_duplicate_columns(evals_dataframe),
        # Eval specific
